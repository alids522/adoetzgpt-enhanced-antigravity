...
IMAGES_GEMINI_API_BASE_URL = PersistentConfig(
    ...
    os.getenv('IMAGES_GEMINI_API_BASE_URL', GEMINI_API_BASE_URL.value),
)
IMAGES_GEMINI_API_KEY = PersistentConfig(
    'IMAGES_GEMINI_API_KEY',
    'image_generation.gemini.api_key',
    os.getenv('IMAGES_GEMINI_API_KEY', GEMINI_API_KEY.value),
)
...
IMAGES_EDIT_GEMINI_API_BASE_URL = PersistentConfig(
    ...
    os.getenv('IMAGES_EDIT_GEMINI_API_BASE_URL', GEMINI_API_BASE_URL.value),
)
IMAGES_EDIT_GEMINI_API_KEY = PersistentConfig(
    'IMAGES_EDIT_GEMINI_API_KEY',
    'images.edit.gemini.api_key',
    os.getenv('IMAGES_EDIT_GEMINI_API_KEY', GEMINI_API_KEY.value),
)
