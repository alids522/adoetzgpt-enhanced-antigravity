<script lang="ts">
	...
	import { estimateTokens, formatTokenCount } from '$lib/stores/tokenUsage';
			...
			{:else if message.content !== ''}
				<div class="w-full">
					...
					{#if messageTokenCount > 0}
						<div class="flex justify-end pr-2 text-[10px] font-medium text-gray-400 dark:text-gray-500">
